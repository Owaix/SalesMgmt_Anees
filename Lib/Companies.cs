    ...
    public class Companies
    {
       ...
       // public Companies()
        //{
            ...
            //CompaniesList.Add(new CompaniesModel   { CompanyID = 2000,CompanyTitle = "New Dawn Electronics",CompanyAddress = "Foujdari Road, Rambo Center Street, Hyderabad",CompanyPhone = "0321-3772088"});
            ...
            public Companies()
            {
                ...
                // ✅ Use AddCompany instead of CompaniesList.Add
                AddCompany(new CompaniesModel { CompanyID = 101, CompanyTitle = "IceSmoke", CompanyAddress = "Shop#A-29,Sahara Arcade,main boulevard,Bahria enclave, Islamabad", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1012, CompanyTitle = "DSADsl kdlsa", CompanyAddress = "Shop#A-29,Sahara Arcade,main boulevard,Bahria enclave, Islamabad", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1013, CompanyTitle = "Elegance Pharmacy Medical Store", CompanyAddress = "65B Block-A Latifabad no 6 ,hyderabad ContactNo :03180303078 , 03111995559", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1014, CompanyTitle = "Elegance Pharmacy Medical Store", CompanyAddress = "65B Block-A Latifabad no 6 ,hyderabad ContactNo :03180303078 , 03111995559", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1015, CompanyTitle = "Noman Traders By NMH", CompanyAddress = "65B Block-A Latifabad no 6 ,hyderabad ContactNo :03180303078 , 03111995559", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1016, CompanyTitle = "Fruitanic", CompanyAddress = "65B Block-A Latifabad no 6 ,hyderabad ContactNo :03180303078 , 03111995559", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1017, CompanyTitle = "Pharma Company", CompanyAddress = "65B Block-A Latifabad no 6 ,hyderabad ContactNo :03180303078 , 03111995559", CompanyPhone = "0317-0000623" });
                AddCompany(new CompaniesModel { CompanyID = 1018, CompanyTitle = "Brohi Balochistan Restuarent", CompanyAddress = "Alhamd Center Opp Board Office unit no 6 Latifabad", CompanyPhone = "" });
                AddCompany(new CompaniesModel { CompanyID = 1020, CompanyTitle = "Riksha Biryani", CompanyAddress = "Jama Masjid Road near Meri chai ka hotel Unit No 8 (Hyd)", CompanyPhone = "03127660027 03352716657" });
                ...
                // ✅ This is your 2000 company
                AddCompany(new CompaniesModel { CompanyID = 2000, CompanyTitle = "New Dawn Electronics", CompanyAddress = "Foujdari Road, Rambo Center Street, Hyderabad", CompanyPhone = "0321-3772088" });

            }

            private void AddCompany(CompaniesModel company)
            {
                if (CompaniesList.Any(c => c.CompanyID == company.CompanyID))
                {
                    throw new Exception($"Duplicate CompanyID detected: {company.CompanyID}");
                }
