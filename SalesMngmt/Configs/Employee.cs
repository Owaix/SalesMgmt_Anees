...
namespace SalesMngmt.Configs
{
    public partial class Employee : MetroFramework.Forms.MetroForm
    {
        ...
        public Employee(int cmpID)
        {
            ...
            compID = cmpID;
            pnlMain.Hide();
            list = db.tbl_Employee.AsNoTracking().Where(x => x.companyID == compID).ToList();
        ...
        private void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var listcancel = db.tbl_Employee.AsNoTracking().Where(x => x.companyID == compID).ToList();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    var Currentobj = db.tbl_Employee.AsNoTracking().Where(x => x.companyID == compID).ToList().Find(x => x.EmployeName == txtCOA.Text.Trim());
                    if (obj.ID == 0)
                    {
                        if (Currentobj != null)
                        {
                    ...
                    obj.AllowTable = Convert.ToInt32(txtallowtable.Text);
                   ...
                   // obj.PyteTypeID = Convert.ToInt32(cmbxParty.SelectedValue);
                    ...
                    else
                    {
                        ...
                        if (result != null)
                        {
                            ...
                            // result.PyteTypeID = (int)cmbxParty.SelectedValue;
                            result.AllowTable = Convert.ToInt32(txtallowtable.Text);
                    ...
                    if (!isAdd)
                    {
                        gl = db.GL.Where(b => b.AC_Code == obj.ACCode && b.TypeCode == 0 && b.RID == 0 && b.CompID == compID).FirstOrDefault();
                    }
                    gl.RID = 0;
                    gl.RID2 = 0;
                    gl.TypeCode = 0;
                    ...
                    if (!isAdd)
                    {
                        gl2 = db.GL.Where(b => b.AC_Code2 == obj.ACCode && b.TypeCode == 0 && b.RID == 0 && b.CompID == compID).FirstOrDefault();
                    }
                    gl2.RID = 0;
                    gl2.RID2 = 0;
                    gl2.TypeCode = 0;
