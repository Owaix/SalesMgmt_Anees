    ...
    public partial class FVendor : MetroFramework.Forms.MetroForm
    {
        ...
        private void VendDataGridView_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 14)
            {
                ...
                Reporting.vendorLedgerSummary ledger = new Reporting.vendorLedgerSummary(compID);
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    VendBindingSource.DataSource = list.FindAll(x => x.VendName.ToLower().Contains(toolStripTextBoxFind.Text.ToLower().Trim()));
                }
            }
            catch (Exception)
            {
