...
namespace SalesMngmt.Invoice
{
    public partial class ExpenseVoucher : MetroFramework.Forms.MetroForm
    {
        ...
        public ExpenseVoucher(int company)
        {
            InitializeComponent();
        ...
        private void Category_Load(object sender, EventArgs e)
        {
            ...
            FillCombo(cmbxCustomer, db.COA_D.Where(x => x.CAC_Code == 16 && x.InActive==false && x.CompanyID==compID).ToList(), "AC_Title", "AC_Code",0);
        ...
        {/*txtArticalNo.Text == ""*/
            ...
            else
            {
               ...
               // obj1.Create_User_ID = customer;
                ...
                var all = db.GL.Where(x => x.TypeCode == 16 && x.RID == obj && x.CompID==compID);
            ...
            var list1 = ReportsController.ExpenseVoucharIndex(DateTime.Today.AddDays(-10), DateTime.Now, compID);
            expenseVoucherIndexResultBindingSource.DataSource = list1;
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var list1 = ReportsController.ExpenseVoucharIndex(dtTo.Value, dtFrom.Value,compID);
            expenseVoucherIndexResultBindingSource.DataSource = list1;
