...
{
    public partial class VendorCurrentBalanceList : Form
    {

        SaleManagerEntities db = null;
        int compy = 0;
        public VendorCurrentBalanceList(int company)
        {
            InitializeComponent();
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            {
                lblAmount.Text = "0";
                var customer = db.Vendors.AsNoTracking().Where(x => x.InActive == false && x.CompanyID == compy);
                ...
                foreach (var cus in customer)
                {
                    ...
                    var previosBalance = ReportsController.getCustomerPreviousBalance(dtpDate.Value,(int) cus.AC_Code);
                    ...
                    var getdata = ReportsController.getcustomerLedgerSummaryByDate(dtpDate.Value, dtpDate.Value, (int)cus.AC_Code);//db.getVendorLedgerBYDate(dtTo.Value, dtFrom.Value,;
                    ...
                    dataGridView1.Rows.Add(a, cus.VendName, balance);
                    a++;
                }
                ...
                lblAmount.Text = "0";
                var customer = db.Vendors.AsNoTracking().Where(x => x.InActive == false && x.CompanyID == compy && x.City== city);
                double TotalcustomersBalance = 0;
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            ...
            for (int a = 0; a < dataGridView1.Rows.Count; a++)
            {
              ...
              order.Note = "VENDOR CURRENT BALANCE";
                int city =Convert.ToInt32( cmbxCity.SelectedValue);
