    ...
    public partial class CustomerLedgerSummary : Form
    {
        ...
        public void customerledgers(int code)
        {
            ...
            foreach (DataRow rows in getdata.Rows) {
                ...
                CategorysDataGridView.Rows.Add(a, rows["GLDate"], rows["reference"], (double)rows["debit"], (double)rows["credit"], (double)balance, "", (int)rows["TypeCode"],(int) rows["RID"]);
                a++;
        ...
        public CustomerLedgerSummary(int company)
        {
            InitializeComponent();
        ...
        {
              FillCombo(cmbxVendor, db.Customers.Where(x => x.CompanyID == compID && x.InActive==false).ToList(), "CusName", "AC_Code", 0);
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            var previosBalance = ReportsController.getCustomerPreviousBalance(dtTOdate.Value, Vendorcode);
            int a = 1;
        ...
        public void customerledger(int code)
        {
            ...
            var previosBalance = ReportsController.getCustomerPreviousBalance(DateTime.Now, code);
            int a = 1;
            ...
            var getdata = ReportsController.getcustomerLedgerSummaryByDate(DateTime.Now.AddDays(-10), dtFrom.Value, code);//db.getVendorLedgerBYDate(dtTo.Value, dtFrom.Value,;
            ...
            foreach (DataRow rows in getdata.Rows) {
                ...
                CategorysDataGridView.Rows.Add(a, (DateTime)rows["GLDate"], rows["reference"], (double)rows["debit"], (double)rows["credit"], (double)balance, rows["Narration"]);
                a++;
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            ...
            for (int a = 0; a < CategorysDataGridView.Rows.Count; a++)
            {
                ...
                order.Name =db.Customers.Where(x=>x.AC_Code== code).FirstOrDefault().CusName;
                ...
                order.LegerName = "CUSTOMER LEDGER";
